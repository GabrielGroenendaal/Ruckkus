...
const DirectMessage = (props) => {
      const [content, setContent] = useState(props.direct_message.content)
      const [edit, setEdit] = useState(false)

      useEffect(() => {
            if (edit) {
                  const messageContainer = document.querySelector(`#directMessage-${props.direct_message.id}`)
      ...
      const messageOptions = () => {
            if (props.currentUser.id === props.direct_message.user.id) {
                  return (
                        <div className="message-button-shell">
                              ...
                              <div onClick={() => props.deleteDirectMessage(props.direct_message.id)}>
                                    <svg aria-hidden="false" width="16" height="16" viewBox="0 0 24 24"><path fill="currentColor" d="M15 3.999V2H9V3.999H3V5.999H21V3.999H15Z"></path><path fill="currentColor" d="M5 6.99902V18.999C5 20.101 5.897 20.999 7 20.999H17C18.103 20.999 19 20.101 19 18.999V6.99902H5ZM11 17H9V11H11V17ZM15 17H13V11H15V17Z"></path></svg>
                              </div>
                        </div>
                  )
            }
      ...
      const handleSubmit = (e) => {
            ...
            let directMessage = props.direct_message
            directMessage.content = content;
            props.updateDirectMessage(directMessage)
            setEdit(!edit)
      }
